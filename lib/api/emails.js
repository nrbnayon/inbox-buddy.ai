...
export const emailApi = {
  ...
  // Search emails
  searchEmails: async (query, timeFilter) => {
    const response = await axiosInstance.get("/emails/search", {
      params: { q: query, timeFilter },
    });
    return response.data;
  },

  // Fetch important emails
  fetchImportantEmails: async (params = {}) => {
    const response = await axiosInstance.get("/emails/important", { params });
    return response.data;
  },
