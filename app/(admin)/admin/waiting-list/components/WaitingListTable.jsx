...
export default function WaitingListTable() {
  ...
  const itemsPerPage = 5; // Constant instead of state since it's fixed
  ...
  if (isLoading && !waitingListUsers.length) {
    return (
      <div className="py-10 text-center">Loading waiting list users...</div>
    );
  }
      ...
      <Dialog open={isDetailsOpen} onOpenChange={setIsDetailsOpen}>
        <DialogContent className="sm:max-w-lg">
          ...
          <DialogFooter className="sm:justify-end">
            ...
            <Button onClick={handleGiveAccess}>Approve Access</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
